...
// *****************************************************************************
// Function:  setAvaSpecParameters 
//
//  \brief:   Configure MeasConfigType, called in Spectrometer.setMeasureConfig   
// 
//  \TODO:    Once it is determined which values will be constant and which
//            will be changed by the uplink, some of these configurations
//            can be added to the Spectrometer constructor
//
// *****************************************************************************
//

setAvaSpecParameters(MeasConfigType* a_pMeasConfig)
{
